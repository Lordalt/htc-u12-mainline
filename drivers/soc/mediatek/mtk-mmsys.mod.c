...
KSYMTAB_FUNC(mtk_mmsys_ddp_connect, "_gpl", "");
KSYMTAB_FUNC(mtk_mmsys_ddp_disconnect, "_gpl", "");
KSYMTAB_FUNC(mtk_mmsys_merge_async_config, "_gpl", "");
KSYMTAB_FUNC(mtk_mmsys_hdr_config, "_gpl", "");
KSYMTAB_FUNC(mtk_mmsys_mixer_in_config, "_gpl", "");
KSYMTAB_FUNC(mtk_mmsys_mixer_in_channel_swap, "_gpl", "");
KSYMTAB_FUNC(mtk_mmsys_ddp_dpi_fmt_config, "_gpl", "");
KSYMTAB_FUNC(mtk_mmsys_vpp_rsz_merge_config, "_gpl", "");
KSYMTAB_FUNC(mtk_mmsys_vpp_rsz_dcm_config, "_gpl", "");
