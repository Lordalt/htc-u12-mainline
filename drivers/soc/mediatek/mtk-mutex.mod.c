...
KSYMTAB_FUNC(mtk_mutex_get, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_put, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_prepare, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_unprepare, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_add_comp, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_remove_comp, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_enable, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_enable_by_cmdq, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_disable, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_acquire, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_release, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_write_mod, "_gpl", "");
KSYMTAB_FUNC(mtk_mutex_write_sof, "_gpl", "");
