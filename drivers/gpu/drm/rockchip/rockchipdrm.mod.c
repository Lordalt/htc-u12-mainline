...
KSYMTAB_DATA(vop2_component_ops, "_gpl", "");
...
MODULE_ALIAS("of:N*T*Crockchip,rk3566-vop");
MODULE_ALIAS("of:N*T*Crockchip,rk3566-vopC*");
MODULE_ALIAS("of:N*T*Crockchip,rk3568-vop");
MODULE_ALIAS("of:N*T*Crockchip,rk3568-vopC*");
