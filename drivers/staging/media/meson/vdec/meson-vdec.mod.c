...
KSYMTAB_FUNC(amvdec_am21c_body_size, "_gpl", "");
KSYMTAB_FUNC(amvdec_am21c_head_size, "_gpl", "");
KSYMTAB_FUNC(amvdec_am21c_size, "_gpl", "");
...
MODULE_INFO(depends, "v4l2-mem2mem,videobuf2-v4l2,videodev,videobuf2-dma-contig,meson-canvas,videobuf2-common");
