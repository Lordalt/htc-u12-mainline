...
KSYMTAB_FUNC(scp_get, "_gpl", "");
KSYMTAB_FUNC(scp_put, "_gpl", "");
KSYMTAB_FUNC(scp_get_device, "_gpl", "");
KSYMTAB_FUNC(scp_get_rproc, "_gpl", "");
KSYMTAB_FUNC(scp_get_vdec_hw_capa, "_gpl", "");
KSYMTAB_FUNC(scp_get_venc_hw_capa, "_gpl", "");
KSYMTAB_FUNC(scp_mapping_dm_addr, "_gpl", "");
...
MODULE_ALIAS("of:N*T*Cmediatek,mt8195-scp-dual");
MODULE_ALIAS("of:N*T*Cmediatek,mt8195-scp-dualC*");
